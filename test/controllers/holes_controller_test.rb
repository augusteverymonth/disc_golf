...
class HolesControllerTest < ActionController::TestCase
  ...
  test "should create hole" do
    assert_difference('Hole.count') do
      post :create, hole: { course_id: @hole.course_id, name: @hole.name, par: @hole.par, par: @hole.par, scorecard_id: @hole.scorecard_id }
    end
  ...
  test "should update hole" do
    patch :update, id: @hole, hole: { course_id: @hole.course_id, name: @hole.name, par: @hole.par, par: @hole.par, scorecard_id: @hole.scorecard_id }
    assert_redirected_to hole_path(assigns(:hole))
  end
